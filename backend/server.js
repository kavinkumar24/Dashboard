   ...
   app.get('/pending_data', (req, res)=> {
      ...
      app.post('/create-task', (req, res) => {
         const { taskName, description, taskId, collectionName, project, priority, isUrgent, assignDate, targetDate } = req.body;
         
         const sql = `
             INSERT INTO tasks (taskName, description, taskId, collectionName, project, priority, isUrgent, assignDate, targetDate)
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
         `;
     
         const values = [taskName, description, taskId, collectionName, project, priority, isUrgent ? 1 : 0, assignDate, targetDate];
