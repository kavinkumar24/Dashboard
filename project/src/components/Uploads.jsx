...
//         setDetailedData([
//           "Brief number",	"Pre-Brief",	"Employe id",	"Employe Name"	,"Design center"	,'Design specification'	,"Jewel sub type"	,"Sub category"	,"Jewel type",	"Document date"	,"Design type"	,"Minimum Weight"	,"Maximum Weight"	,"No Of Design"	,"Deadline date",	"Confirmed"	,"Received",	"Received by",	"Received date",	"Completed",	"Created by",	"Created date and time"
//         ]);
...
//       // Compare uploaded columns with the expected detailedData columns
//       const mismatchedColumns = uploadedColumns.filter(
//         (col) => !detailedData.includes(col)
//       );
      
//       if (mismatchedColumns.length > 0) {
//         setMessage(`Column mismatch! These columns are incorrect: ${mismatchedColumns.join(", ")}`);
//         return; // Block the upload if there are mismatched columns
//       }
...
//             <option value="task">Design Center Task</option>
//           </select>
...
//               </p>
//             </label>
//             {message && (message === "File uploaded successfully!") ? <p className="m-4 text-green-500">{message}</p> : <p className="m-4 text-red-500">{message}</p>}
//           </div>
