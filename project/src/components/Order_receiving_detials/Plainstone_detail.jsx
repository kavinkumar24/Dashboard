...
const ProjectDetails = () => {
  ...
  const handleTop15Click = () => {
    if (!isSelected) {
      ...
      setProductAcc(
        (originalData && aggregateData(originalData).productAcc) || {}
      );
    }
    setIsSelected(!isSelected);
    if (grouppartyChartRef.current) {
      grouppartyChartRef.current.scrollIntoView({
        behavior: "smooth",
        block: "start",
      });
    }
  ...
  const monthChartData = {
    labels: Object.keys(monthAcc).map(
            ...
            <div className="flex space-x-4">
              ...
              >
                <h1 className="col-span-2">
                  Details for Plain Stone: {plainstone} in{" "}
              ...
              >
                ...
                >
                  Date: {formatParam(dateParam) || "All"}
                </h1>
              </div>
              ...
              >
                ...
                >
                  Month: {formatParam(monthParam) || "All"}
                </h1>
              </div>
              ...
              >
                ...
                >
                  Year: {formatParam(yearParam) || "All"}
                </h1>
              </div>
            </div>
          </div>
