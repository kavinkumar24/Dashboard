...
const ProjectDetails = () => {
  ...
  const validValues = Object.values(projectAcc).filter(value => value != null && value !== 0);
...
const plainstone = {
  ...
  <div className="flex space-x-4">
    <div className={`rounded-lg shadow-md p-3 flex items-center ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white'}`}>
      <h1 className="col-span-2">Details for Project: {project} in {formattedTotalWeight} kg</h1>
    </div>
