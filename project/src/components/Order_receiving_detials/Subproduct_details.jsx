...
const PurityDetail = () => {
  ...
  const handleTop15Click = () => {
    if (!isSelected) {
      if (originalData) {
        const categoryFilteredData = originalData.filter(item => item["SUB PRODUCT"] === subproduct);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredData = jsonData.filter(item => item["SUB PRODUCT"] === subproduct);
  ...
  const { purityAcc, projectAcc, productAcc, subproductAcc, colorAcc } = aggregateData(data);
...
>
  ...
  <h1 className="col-span-2">Details for Sub Product: {subproduct}</h1>

  {/* Purity Chart */}
  <div
    className={`order-1 col-span-2 lg:col-span-1 ${
      theme === "light" ? "bg-white" : "bg-gray-900"
    } p-4 rounded shadow-lg h-[500px] overflow-auto`}
  >
  ...
  {/* Project Chart */}
 <div
    className={`order-2 col-span-2 lg:col-span-1 ${
      theme === "light" ? "bg-white" : "bg-gray-900"
    } p-4 rounded shadow-lg h-[500px] overflow-auto`}
  >
 ...
 {/* Color Chart */}
<div
  className={`order-5 col-span-2 lg:col-span-1 flex justify-center items-center h-[600px] ${
    theme === "light" ? "bg-white" : "bg-gray-900"
...
>
  ...
  <div
    className={`order-3 col-span-2 lg:col-span-1 ${
      theme === "light" ? "bg-white" : "bg-gray-900"
    } p-4 rounded shadow-lg max-h-[750px] overflow-auto`}
  >
  ...
  <div
            className={`order-4 col-span-1 ${
              theme === "light" ? "bg-white" : "bg-gray-900"
            } p-4 rounded shadow-md overflow-auto h-[350px] custom-scrollbar`}
          >
