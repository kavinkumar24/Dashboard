  ...
  const processFetchedData = (data) => {
    const allYears = new Set();
          ...
          const filteredData = data.filter((item) => {
            ...
            const yearMatch =
              !selectedYear.length || selectedYear.includes(itemYear);
            const monthMatch =
        ...
        let sortedProjectData = [...currentProjectData].sort(
          (a, b) => b.kg - a.kg
        );
        let sortedProductData = [...currentProductData].sort(
          (a, b) => b.kg - a.kg
        );
  ...
  datasets: [
    {
      ...
      data: Object.values(finalSortedMonthData).map(value => value / 1000),
  ...
  // };
    ...
    const filteredLineChartData = () => {
      ...
      if (!Array.isArray(chartmonthData.datasets)) {
        console.error("chartmonthData.datasets is not an array:", chartmonthData.datasets);
      ...
      const filteredData = chartmonthData.labels
        .map((label, index) => {
          ...
          if (monthDate.getFullYear() === yearToDisplay) {
            return {
              label,
              monthIndex: monthOrder.indexOf(monthDate.toLocaleString('default', { month: 'long' })),
...
<div className={`m-4 py-4 px-8 border rounded-lg ${theme === "light" ? "bg-white border-gray-300" : "bg-slate-900 border-zinc-800"} shadow-lg`}>
  Total : <span className="text-red-500">{totalWeight.toFixed(2)}</span>
</div>

<div className={`m-4 px-8 border rounded-lg ${theme === "light" ? "bg-white border-gray-300" : "bg-slate-900 border-zinc-800"} shadow-lg`}>
  <button onClick={() => toggleAccordion1(1)} className="w-full flex justify-between items-center py-4">
    <span className={`text-lg font-semibold ${theme === "light" ? "text-slate-800" : "text-slate-300"}`}>
      Top <span className="text-red-500">25</span> Group party
    </span>
    <span className="text-slate-800 transition-transform duration-300">
      {activeIndex1 === 1 ? (
        <FiMinusCircle className={`text-2xl ${theme === "light" ? "text-gray-800" : "text-gray-300"}`} />
      ) : (
        <IoIosAddCircleOutline className={`text-2xl ${theme === "light" ? "text-gray-800" : "text-gray-300"}`} />
      )}
    </span>
  </button>

  <div className={`${activeIndex1 === 1 ? "max-h-screen" : "max-h-0"} overflow-hidden transition-all duration-300 ease-in-out`}>
    <div className={`m-4 border rounded-lg ${theme === "light" ? "border-gray-300 bg-white" : "border-slate-700 bg-slate-800"} shadow-lg`}>
      <table className={`w-full text-left table-auto text-sm ${theme === "light" ? "bg-white text-gray-800" : "bg-slate-800 text-gray-300"}`}>
        <thead>
          <tr className={`${theme === "light" ? "bg-gray-200" : "bg-slate-700"}`}>
            <th className={`p-2 border ${theme === "light" ? "border-gray-200" : "border-gray-700"} text-center`}>Group party</th>
            <th align="center" className={`p-2 border ${theme === "light" ? "border-gray-200" : "border-gray-700"} text-center`}>Project</th>
        ...
        <tbody>
          {currentdata1.map((item, index) => (
            <tr key={index}>
              <td className={`p-2 border ${theme === "light" ? "border-gray-200" : "border-gray-700"} text-center`}>{item["Group party"]}</td>
              <td className={`p-2 border ${theme === "light" ? "border-gray-200" : "border-gray-700"} text-center`}>{item.PROJECT}</td>
              <td className={`p-2 border ${theme === "light" ? "border-gray-200" : "border-gray-700"} text-center`}>{(item.WT).toFixed(2)}</td>
            </tr>
          ))}
        </tbody>
      </table>
      ...
      <div className="flex justify-center mt-4 mb-4">
        <button className={`mx-1 px-3 py-1 rounded ${theme === "light" ? "bg-gray-200 text-gray-800" : "bg-slate-700 text-gray-300"}`} onClick={() => handlePageChange1(currentPage1 - 1)} disabled={currentPage1 === 1}>
          Previous
        </button>
        {[...Array(totalpages1)].map((_, pageIndex) => (
          <button key={pageIndex} className={`mx-1 px-3 py-1 rounded ${currentPage1 === pageIndex + 1 ? "bg-blue-500 text-white" : theme === "light" ? "bg-gray-200 text-gray-800" : "bg-slate-700 text-gray-300"}`} onClick={() => handlePageChange1(pageIndex + 1)}>
            {pageIndex + 1}
          </button>
        ))}
        <button className={`mx-1 px-3 py-1 rounded ${theme === "light" ? "bg-gray-200 text-gray-800" : "bg-slate-700 text-gray-300"}`} onClick={() => handlePageChange1(currentPage1 + 1)} disabled={currentPage1 === totalpages1}>
          Next
        </button>
      </div>
    </div>
...
<div className={`m-4 px-10 border rounded-lg ${theme === "light" ? "bg-white border-gray-300" : "bg-slate-900 border-zinc-800"} shadow-lg`}>
  ...
  <div className={`${activeIndex === 1 ? "max-h-screen" : "max-h-0"} overflow-hidden transition-all duration-300 ease-in-out`}>
    <div className={`m-4 border rounded-lg ${theme === "light" ? "border-gray-300 bg-white" : "border-slate-700 bg-slate-800"} shadow-lg`}>
      <table className={`w-full text-left table-auto text-sm ${theme === "light" ? "bg-white text-gray-800" : "bg-slate-800 text-gray-300"}`}>
        <thead>
          <tr className={`${theme === "light" ? "bg-gray-200" : "bg-slate-700"}`}>
            <th className="p-2 border text-center">Photo No 2</th>
            <th align="center" className="p-2 border text-center">Project</th>
        ...
        <tbody>
          {currentData.map((item, index) => (
            <tr key={index}>
              ...
              <td className="p-2 border text-center">{(item.WT).toFixed(2)}</td>
            </tr>
          ))}
        </tbody>
      </table>
      ...
      <div className="flex justify-center mt-4 mb-4">
        <button className={`mx-1 px-3 py-1 rounded ${theme === "light" ? "bg-gray-200 text-gray-800" : "bg-slate-700 text-gray-300"}`} onClick={() => handlePageChange(currentPage - 1)} disabled={currentPage === 1}>
          Previous
        </button>
        {[...Array(totalPages)].map((_, pageIndex) => (
          <button key={pageIndex} className={`mx-1 px-3 py-1 rounded ${currentPage === pageIndex + 1 ? "bg-blue-500 text-white" : theme === "light" ? "bg-gray-200 text-gray-800" : "bg-slate-700 text-gray-300"}`} onClick={() => handlePageChange(pageIndex + 1)}>
            {pageIndex + 1}
          </button>
        ))}
        <button className={`mx-1 px-3 py-1 rounded ${theme === "light" ? "bg-gray-200 text-gray-800" : "bg-slate-700 text-gray-300"}`} onClick={() => handlePageChange(currentPage + 1)} disabled={currentPage === totalPages}>
          Next
        </button>
      </div>
    </div>
                  ...
                  plugins: {
                    ...
                    datalabels: {
                      ...
                      formatter: (value, context) => {
                        const totalWeight = getPurityData(overall_data_filtered).reduce(
              ...
              options={{
                ...
                plugins: {
                  datalabels: {
                    ...
                    anchor: "end",
                    formatter: (value, context) => {
                      const totalWeight = getZoneData(overall_data_filtered).reduce(
                        (acc, entry) => acc + entry.kg,
                        0
                      );
                      if (totalWeight === 0) {
              ...
              options={{
                ...
                plugins: {
                  ...
                  tooltip: {
                    callbacks: {
                      label: function (context) {
                        const totalWeight = getProduct(overall_data_filtered).reduce(
                          (acc, entry) => acc + entry.kg,
                          0
                        );
                        const percentage = (
                ...
                options={{
                  ...
                  plugins: {
                    ...
                    tooltip: {
                      callbacks: {
                        label: function (context) {
                          const totalWeight = getplainStone(overall_data_filtered).reduce(
                            (acc, entry) => acc + entry.kg,
                            0
                          );
                          const percentage = (
              ...
              options={{
                ...
                plugins: {
                  ...
                  tooltip: {
                    callbacks: {
                      label: function (context) {
                        const totalWeight = getProject(overall_data_filtered).reduce(
                          (acc, entry) => acc + entry.kg,
                          0
                        );
                        const percentage = (
   ...
   h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] xl:h-[450px] 2xl:h-[600px]`}
        >
          ...
          <Bar
            ...
            options={{
              onClick: (event, chartElement) =>
                handleClick_produt_detail(event, chartElement),
              responsive: true,
              maintainAspectRatio: false,
              indexAxis: "y",
              plugins: {
                ...
                tooltip: {
                  callbacks: {
                    label: function (context) {
                      const totalWeight = getsubproduct(overall_data_filtered).reduce(
                        (acc, entry) => acc + entry.kg,
                        0
                      );
                      const percentage = (
